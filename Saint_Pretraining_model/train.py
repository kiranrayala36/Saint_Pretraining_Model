...
if __name__=='__main__':
    ...
    if opt.task =='binary':
        ...
        #print("Accuracy:",(100-best_test_rmse)/100)
    ...
    epoch_count = range(1, len(validrmse) + 1)
    plt.title("Epoch VS Validation RMSE")
    plt.xlabel('Epoch')
    plt.ylabel('Validation RMSE')
    plt.plot(epoch_count,validrmse)
    plt.show()

    plt.title("Epoch VS Test RMSE")
    plt.xlabel('Epoch')
    plt.ylabel('Test RMSE')
    plt.plot(epoch_count,testrmse)
    plt.show()

    plt.title("Epoch VS Loss Activation")
    plt.xlabel('Epoch')
    plt.ylabel('Loss Activation')
    plt.plot(epoch_count,testrmse,label="Test loss Activation")
    plt.plot(epoch_count,validrmse,label="Valid loss Activation")
    plt.legend()
    plt.show()

    no_epoch=range(1,len(lossfn)+1)
    plt.title("Epoch VS Training Loss")
    plt.xlabel('Epoch')
    plt.ylabel('Training Loss')
    plt.plot(no_epoch,lossfn)
    plt.show()